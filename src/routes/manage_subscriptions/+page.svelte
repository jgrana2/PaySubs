...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
	<div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
		<a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
			<img src="logo.jpg" class="h-8" alt="PayGate Logo" />
			<span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white"
				>PayGate</span
			>
		</a>

		<div class="flex items-cenier md:order-2 md:space-x-0 rtl:space-x-reverse">
			...
			<Dropdown triggeredBy="#user-drop">
				...
				<DropdownItem href="manage_subscriptions">Gestionar suscripciones</DropdownItem>
				<DropdownItem href="manage_cards">Métodos de pago</DropdownItem>
				<DropdownDivider />
...
<section class="bg-gray-50 dark:bg-gray-900 pt-4">
	<div class="mx-auto max-w-screen-2xl lg:px-12 container">
		<div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
			<div class="grid justify-items-stretch grid-cols-2 px-4 py-3">
				<div>
					<h3 class="text-2xl font-bold sm:text-3xl">Suscripciones</h3>
				</div>
			</div>
